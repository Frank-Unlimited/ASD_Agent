...
系统使用 Google Custom Search API 进行真正的联网搜索，获得最准确的搜索结果。

**注意**：必须配置 Google Search API 才能使用联网搜索功能，否则搜索将返回空结果。
...
### Q: 必须配置吗？
A: 是的，联网搜索功能依赖 Google Search API。不配置将无法使用联网搜索，搜索会返回空结果。
